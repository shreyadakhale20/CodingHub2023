...
namespace WorldDanceChampionship
{
    internal class EmployeeDatabase
    {
        ...
        public static string InputEmployee(int employeeId, string employeeName, string gender, string email, long mobileNumber, string city, string DOB)
        {
            ...
            string query = "insert into Employee1(employeeId, employeeName, gender, email, mobileNumber, city, DOB) " +
        ...
        {
            SqlConnection con = GetConnection();
            string query = "update Employee1 set employeeName = @employeeName where employeeId = @employeeId";
            try
            {
                SqlCommand command = new SqlCommand(query, con);
                command.Parameters.AddWithValue("@employeeName", employeeName);
        ...
        {
            SqlConnection con = GetConnection();
            string query = "select * from city1";
